...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_port', type=int, default=9009, help='visdom port of the web display')
        ...
        parser.add_argument('--adam_config_b1', type=float, default=0, help='momentum term of adam')
        parser.add_argument('--adam_config_b2', type=float, default=0.999, help='momentum term of adam')
        ...
        parser.add_argument('--lr_decay_iters', type=int, default=45, help='multiply by a gamma every lr_decay_iters iterations')
