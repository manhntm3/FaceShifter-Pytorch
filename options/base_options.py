...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/root/FaceDataset/', help='path to images')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='aeinet', help='chooses which model to use.')
        ...
        # dataset parameters
        parser.add_argument('--dataset_name', type=list, default=['celeba_hq','FFHQ','VGGFace2'], help='chooses how datasets are loaded')
        parser.add_argument('--dataset_type', type=list, default=['face_file','face_file','face_folder'], help='chooses how datasets are loaded')
        parser.add_argument('--dataset_mode', type=str, default='face', help='chooses how datasets are loaded')
